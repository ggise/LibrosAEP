<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Generos.aspx.cs" Inherits="LibrosAEP.Generos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="ContenedorPrincipal">
        <div class="container-listas">
            <div class="d-flex justify-content-end" style="margin-bottom: 20px">
                <asp:Button Text=" Nuevo Genero" CssClass="btn btn-primary" ID="btnAgregarNuevo" OnClick="btnAgregarNuevo_Click" runat="server" />
            </div>
            <table>
                <thead>
